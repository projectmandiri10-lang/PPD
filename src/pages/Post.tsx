            ...
            <div className="card p-6 sticky top-24">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4">
                ...
                <div className="flex gap-2">
                  ...
                  <a
                    href={`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(downloadPageUrl)}&media=${encodeURIComponent(getImageUrl(item))}&description=${encodeURIComponent(item.title)}`}
                    target="_blank"
